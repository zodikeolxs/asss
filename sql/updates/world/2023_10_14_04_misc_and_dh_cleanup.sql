DELETE FROM `creature_addon` WHERE `guid`=350896;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (350896, 0, 0, 8, 0, 0, NULL);

DELETE FROM `creature_addon` WHERE `guid`=350885;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (350885, 0, 0, 8, 0, 0, NULL);

DELETE FROM `creature_addon` WHERE `guid`=350847;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (350847, 0, 0, 0, 10, 0, NULL);
